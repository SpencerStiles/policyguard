    ...
    <aside className="hidden w-64 flex-shrink-0 border-r border-gray-200 bg-white lg:block">
      <div className="flex h-full flex-col">
        <div className="flex h-16 items-center gap-2.5 border-b border-gray-200 px-6">
          ...
          <span className="text-lg font-bold text-gray-900">PolicyGuard</span>
        </div>
        ...
        <div className="border-t border-gray-200 p-4">
          <div className="rounded-lg bg-brand-50 p-3">
            <p className="text-xs font-medium text-brand-700">PolicyGuard AI v0.1.0</p>
            <p className="mt-0.5 text-xs text-brand-600">Powered by CoPlayground</p>
          </div>
        </div>
      </div>
    </aside>
